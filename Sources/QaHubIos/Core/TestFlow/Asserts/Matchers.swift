...
public func isNotTrue() -> Matcher<Bool> {
    return Matcher(description: "is not", reference: true, checkFunction: {
        value, reference in return value != reference
    })
}

public func equalTo<T: Equatable> (_ reference: T) -> Matcher<T> {
    return Matcher(description: "equals", reference: reference, checkFunction: {
        value, reference in return value == reference
    })
}

public func containsString(_ reference: String) -> Matcher<String> {
...
public func doesntContainString(_ reference: String) -> Matcher<String> {
